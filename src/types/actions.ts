...
export const ACTION_DEFS: ActionDef[] = [
  ...
  },
  {
    id: "scout",
    name: "Scout",
    description: "Explore surroundings. Discovers lootable locations. Small military XP.",
    skill: "military",
    category: "military",
    baseDuration: 60,
    unlockLevel: 3,
  ...
  {
    id: "loot",
    name: "Loot Expedition",
    description: "Send fighters to loot a scouted location. Requires scouted locations and military strength. Rewards increase with each expedition.",
    skill: "military",
    category: "military",
    baseDuration: 100,
    unlockLevel: 4,
  ...
  },
  {
    id: "cure_food",
    name: "Cure Food",
    description: "Prepare and cure food for long-term storage. Converts food into preserved food that spoils much slower. Amount scales with Farming skill.",
    skill: "farming",
    category: "resource",
    baseDuration: 120,
    unlockLevel: 5,
